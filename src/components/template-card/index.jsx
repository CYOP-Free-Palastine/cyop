...
export default function TemplateCard({img, price, link, title}) {
    return (
        <div className="w-full flex flex-col  max-w-xs border rounded-lg shadow bg-gray-800 border-gray-700">
            <Link to={link}>
            ...
            <div className="flex flex-col justify-end items-start flex-grow-[1] pt-1 p-5">
                <Link to={link} className="text-white  focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Create Portfolio</Link>
            </div>
        </div>
    )
}